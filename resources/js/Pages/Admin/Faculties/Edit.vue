<template>
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card card-info glassmorphism">
          ...
          <form @submit.prevent="submit">
            ...
            <div class="card-footer">
              <button type="submit" class="btn btn-info" :disabled="form.processing">Update Faculty</button>
...
const form = useForm({
  user_id: props.faculty.user_id,
  department_id: props.faculty.department_id || '',
  employee_code: props.faculty.employee_code,
  designation: props.faculty.designation || '',
  qualification: props.faculty.qualification || '',
  expertise: props.faculty.expertise || '',
  max_teaching_hours_per_week: props.faculty.max_teaching_hours_per_week,
});

const submit = () => {
  form.put(`/admin/faculties/${props.faculty.id}`);
};
</script>
