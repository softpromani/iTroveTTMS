          ...
          <div class="card card-info">
            ...
            <form @submit.prevent="submit">
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-info" :disabled="form.processing">Update Entry</button>
...
const form = useForm({
  semester_id: props.timetableEntry.semester_id,
  section_id: props.timetableEntry.section_id,
  subject_id: props.timetableEntry.subject_id,
  faculty_id: props.timetableEntry.faculty_id,
  room_id: props.timetableEntry.room_id,
  timetable_slot_id: props.timetableEntry.timetable_slot_id,
  date: props.timetableEntry.date || '',
  status: props.timetableEntry.status
});

const submit = () => {
  form.put(`/admin/timetable-entries/${props.timetableEntry.id}`);
};
</script>
